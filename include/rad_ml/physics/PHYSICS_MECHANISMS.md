...
![Lindblad Master Equation](https://latex.codecogs.com/svg.latex?\Large&space;\frac{d\rho}{dt}=-\frac{i}{\hbar}[H,\rho]+\mathcal{L}_{\text{decoh}}[\rho]+\mathcal{L}_{\text{diss}}[\rho])
